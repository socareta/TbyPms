...
<div class="container">
      <ul class="nav nav-tabs" role="tablist">
          ...
          <li role="presentation" class="active"><a href="<?php echo base_url('frontDesk/folio') ?>" aria-controls="Folio" >Folio</a></li>
        </ul>
            ...
            <table class="table table-bordered" id="">
              ...
              <?php foreach ($myFolio as $dt){?>
                  <tr>
                    ...
                    <td>
                      <div class="dropdown">
                        <button class="btn btn-success dropdown-toggle" data-toggle="dropdown">TOOL<span class="caret"></span></button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class ="resForm" method="POST" action="<?php echo base_url('frontDesk/saveFolio')?>">
           ...
           <div class="form-group">
            ...
            <div class="form-inline">
              <div class="row">
                <div class="col-xs-4">
                <b>Rate USD</b>
                <input type="text" class="form-control" id="rateUSd" name="rateUSd" placeholder="Rate(USD)" width="10px">
                </div>
